...
/* 👉 1. Fix the greet function so that it takes in a string as a parameter called name and logs the message correctly in the console. If no name is specified, have the function use the string "doctor" instead.
 */

function greet(name = `doctor`) {
